...
# Streamlit 界面
st.title('"医院-社区-家庭"三区联合护理模式下骨折老年卧床患者PI风险预测模型')
...
# 添加说明文本
st.markdown("""
本应用基于机器学习模型预测在"医院-社区-家庭"三区联合护理模式下的骨折老年卧床患者PI风险。
...
if model is not None and st.button("开始预测", type="primary"):
    ...
    if probability < 25:
        ...
        risk_level = "高风险"
        color = "red"
        recommendation = "建议：采取强化护理措施，使用专业减压辅具设备，提高评估频率，强化与医院的协同管理，及时启动医疗干预并制定针对性治疗方案"
